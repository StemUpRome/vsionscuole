...
export default function MaterialPage() {
  ...
  const [materials] = useState([
    ...
    { id: 4, name: 'Documento 4' },
    { id: 5, name: 'Documento 5' },
    { id: 6, name: 'Documento 6' },
    { id: 7, name: 'Documento 7' },
  ])

  const handleAddMaterial = () => {
    // TODO: Implementare upload materiale
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <h1 className="text-4xl font-bold text-white mb-2">My material</h1>
              <p className="text-[#A0A0A0] text-base">
                Store your material here for future use
              </p>
            </div>
            <button
              onClick={handleAddMaterial}
              className="w-10 h-10 bg-[#2C2C2E] rounded-lg flex items-center justify-center hover:bg-[#333335] transition-colors"
            >
          ...
          <div className="grid grid-cols-3 gap-4">
            {filteredMaterials.length > 0 ? (
              filteredMaterials.map((material) => (
                <div
                  key={material.id}
                  className="bg-[#2C2C2E] rounded-2xl p-6 cursor-pointer hover:bg-[#333335] transition-colors"
                >
                  <div className="flex flex-col items-center justify-center min-h-[200px]">
                    <div className="relative mb-4">
                      ...
                      <div className="absolute -top-1 -right-1 w-6 h-6 bg-[#6B48FF] rounded-full flex items-center justify-center">
              ...
              <div className="col-span-3 flex items-center justify-center py-16">
                <div className="text-center">
                  ...
                  <p className="text-[#A0A0A0] text-lg mb-2">No materials found</p>
                  <p className="text-[#A0A0A0] text-sm">Add your first material to get started</p>
                </div>
              </div>
            )}
          </div>
