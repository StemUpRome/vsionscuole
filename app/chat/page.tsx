...
export default function ChatPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // TODO: collegare al motore di chat reale
    console.log('New chat prompt:', prompt)
    setPrompt('')
  }
  ...
  return (
    <div className="flex h-screen bg-[#1A1A1A] text-white overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        {/* Top Header */}
        <header className="px-8 py-6 border-b border-[#2C2C2E] flex items-center justify-end">
          <button className="px-6 py-3 bg-[#6B48FF] text-white rounded-xl font-medium hover:bg-[#5A3FE6] transition-colors">
            New Chat
          </button>
        </header>
          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-4 bg-[#18181B] border border-[#2C2C2E] rounded-full text-white placeholder-[#6B6B6B] focus:outline-none focus:border-[#6B48FF] transition-colors"
              />
              <button
                type="submit"
                className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#6B48FF] flex items-center justify-center hover:bg-[#5A3FE6] transition-colors"
              >
